...
const (
	testLocalDocker = "unix:///home/olegvantsevich/.docker/desktop/docker.sock"

	testMigrationPass = "/home/olegvantsevich/GolandProjects/Trading-Service"
...
func TestMain(m *testing.M) {
	...
	pool, err := dockertest.NewPool(testLocalDocker)
	if err != nil {
	...
	postgres, err := pool.RunWithOptions(&dockertest.RunOptions{
		...
		Mounts: []string{fmt.Sprintf("%s/migrations:/docker-entrypoint-initdb.d", testMigrationPass)},
